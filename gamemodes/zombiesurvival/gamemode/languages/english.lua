...
LANGUAGE.banned_for_life_warning					= "You are banned from the arsenal and can't purchase anything!"
LANGUAGE.late_buyer_warning							= "You can't purchase anything until the second half!"
...
LANGUAGE.class_skeletal_prowler						= "Skeletal Prowler"
...
LANGUAGE.class_shadow_lurker						= "Frigid Lurker"
...
LANGUAGE.description_bloated_zombie					= "Their body is comprised of volatile, toxic chemicals which will be discharged towards attackers when harmed.\nAlthough they move slower, they can take slightly more of a beating."
...
LANGUAGE.description_skeletal_prowler				= "A particularly aged and dangerous skeleton that has lost the use of its legs. They take minimal damage from bullets."
...
LANGUAGE.description_shadow_walker					= "Extremely hard to see in the dark and resistant against melee attacks. Their hits inflict a vision dimming debuff."
LANGUAGE.description_frigid_lurker					= "Even when cut in half, this skeleton is cold as ice, and resistant against melee attacks.\nCan chill and blind with its attacks."
...
LANGUAGE.description_skeletal_prowler			= "> PRIMARY: Claws\n> SECONDARY: Moan\n> ON HIT BY BULLET: Resist damage"
...
LANGUAGE.controls_shadow_walker						= "> PRIMARY: Claws\n> RELOAD: Become Lurker\n> ON HIT: Dim Vision\n> ON HIT BY MELEE: Resist damage"
LANGUAGE.controls_frigid_lurker						= "> PRIMARY: Claws\n> ON HIT: Frost and dim vision\n> ON HIT BY MELEE: Resist damage"
